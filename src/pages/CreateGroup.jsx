                ...
                <div className='p-6 lg:p-12'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                            ...
                            <select id="hobbyCategory" name="hobbyCategory" className="input w-full" required>
                        ...
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                            ...
                            <input type="text" name='locatiopn' className="input w-full" placeholder="Meeting Location" />
                        </fieldset>
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
