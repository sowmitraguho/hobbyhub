...
const MemberProfile = ({member}) => {
    ...
    return (
        <div>
            <div className="card bg-base-200 w-66 h-76 shadow-xl border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 dark:text-gray-200">
                <figure>
