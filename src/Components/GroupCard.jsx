...
const GroupCard = ({ group }) => {
    ...
    return (
        <div className='p-6'>
            <div className="flex flex-col h-140  bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <figure>
                ...
                <div className="card-body text-left p-6">
                    ...
                    <p className='font-normal text-gray-700 dark:text-gray-400 line-clamp-4'>About Group: {description}</p>
